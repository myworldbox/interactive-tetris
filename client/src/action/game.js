const Game = (function () {
  ...
  const sounds = {
    signin: new Audio("./src/music/signin.mp3"),
    background: new Audio("./src/music/bg.mp3"),
    clear: new Audio("./src/music/lineCleared.mp3"),
    gameover: new Audio("./src/music/GameOver.mp3"),
  };
